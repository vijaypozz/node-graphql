...
/**
 * A Page Insights Get Request that queries a week metric.
 *
 * @author Tiago Grosso <tiagogrosso99@gmail.com>
 * @since 0.2.0
 */
export declare class GetPageWeekInsightsRequest extends AbstractGetPageTimedInsightsRequest<WeekAndMonthMetric> {
    /**
     * The constructor.
