 ...
 * @since 0.2.0
 */
export declare abstract class AbstractGetPageTimedInsightsRequest<T extends DayMetric | WeekAndMonthMetric> extends AbstractGetPageInsightsRequest<T, GetPageTimedInsightsResponse> {
    /**
     * @inheritdoc
     */
